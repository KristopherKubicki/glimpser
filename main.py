...
DATABASE_PATH = os.getenv('GLIMPSER_DATABASE_PATH', 'data/glimpser.db') # warning, duplicate default value in app/config.py 
...
if __name__ == '__main__':
    ...
    from app.config import HOST, PORT, LOGGING_PATH
