...
The hamburger menu can also be toggled with the keyboard using **Enter** or the **Space** key, and the button updates the `aria-expanded` attribute so screen readers announce the expanded state.
