...
The header navigation uses smaller padding so it stays out of the way on both mobile and desktop. When logged out, the navigation bar is hidden entirely.
