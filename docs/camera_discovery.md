...
The results table now appears inside a card container and uses the standard camera table styling so the page looks consistent with the rest of the interface.
