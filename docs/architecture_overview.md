...
- Starts the background scheduler and optional watchdog thread.
  ...
  a restart after a configurable number of failures. Tune the
  [watchdog settings](configuration_guide.md#watchdog-settings)
...
- Key modules include:
  ...
  - `browser.py` – utilities for launching browsers and managing HTTP sessions.
