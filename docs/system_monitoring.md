...
page after the screen has been idle for a few seconds. The chyron now sits on
the right side of the header so the Glimpser logo stays visible on the left.
The icon remains green
