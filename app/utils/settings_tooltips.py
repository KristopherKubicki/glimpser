...
SETTINGS_TOOLTIPS = {
    "API_KEY": (
        _(
            "Generated by the platform and used to authorize API calls. Keep this value secret to prevent unauthorized access."
        ),
    ),
    "CHATGPT_KEY": (
    ...
    "LANG": (
        _(
            "Default interface language. Choices include common locale codes such as en-US or fr-FR."
        ),
    ),
    "TZ": (
