...
def generate_credentials():
    ...
    username = input(f"Enter the username for login [{config.get_setting('USER_NAME', 'admin')}]: ") or config.get_setting('USER_NAME', 'admin')
    ...
    upsert_setting('API_KEY', config.get_setting('API_KEY', secrets.token_hex(32)), conn)
    upsert_setting('CHATGPT_KEY', config.get_setting('CHATGPT_KEY', ''), conn)  # Placeholder for CHATGPT_KEY
